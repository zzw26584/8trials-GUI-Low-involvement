...
      { id: 'e2_1', name: '加厚垃圾袋 B', price: 15.0, rating: 4.4, imageUrl: 'https://images.pexels.com/photos/3962260/pexels-photo-3962260.jpeg', summary: '色彩斑斓。', attributes: [{ label: '封口', value: '抽绳' }, { label: '颜色', value: '白色' }, { label: '数量', value: '30只' }] },
